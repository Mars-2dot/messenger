...
set(command "C:/Program Files/CMake/bin/cmake.exe;-P;G:/code/messenger/test/build/3rd/external_files/tmp/googletest-gitclone.cmake")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "G:/code/messenger/test/build/3rd/external_files/log/googletest-download-out.log")
set(stderr_log "G:/code/messenger/test/build/3rd/external_files/log/googletest-download-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  G:/code/messenger/test/build/3rd/external_files/log/googletest-download-*.log")
  endif()
  ...
  if(NOT "Visual Studio 16 2019" MATCHES "Ninja")
    set(msg "googletest download command succeeded.  See also G:/code/messenger/test/build/3rd/external_files/log/googletest-download-*.log")
    message(STATUS "${msg}")
  endif()
endif()
